% The function 'solve_puzzle' sovles the verbal arithmetic, 
...
solve_puzzle(W1,W2,W3,Res) :- atom_chars(W1,L1),atom_chars(W2,L2),atom_chars(W3,L3),rebus1(L1,L2,L3,Res).          % решение 7б  - принимает атомы, представляющие слова.
