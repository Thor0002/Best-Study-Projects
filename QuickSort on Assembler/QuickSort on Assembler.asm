...
QuickSort:
; the procedure that takes an array of 32-bit signed numbers through the stack 
; and sorts it using the QuickSort algorithm.
; Input:
; [ebp+8]  - the address of the array
; [ebp+12] - the length of the array
; No output
  push ebp
  mov ebp, esp
  pusha
...
; Reads the array size from the console first,
